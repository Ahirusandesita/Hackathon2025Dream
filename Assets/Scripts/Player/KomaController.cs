...
public class KomaController : MonoBehaviour, IInjectPlayer
{
    ...
    private void Initialize()
    {
        ...
        gameManager.Opponent(playerNumber).GetComponent<POWManager>().OnRebellion += (eventData, sender) =>
        {
        ...
        gameManager.Me(playerNumber).GetComponent<POWManager>().OnRebellion += (eventData, sender) =>
        {
